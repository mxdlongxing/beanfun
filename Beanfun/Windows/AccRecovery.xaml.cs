...
namespace Beanfun
{
    ...
    public partial class AccRecovery : Window
    {
        ...
        private void Export_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            ICryptoTransform encrypt_AES = provider_AES.CreateEncryptor(key, md5.ComputeHash(Encoding.UTF8.GetBytes("mxdlongxing")));
        ...
        private void Recovery_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            RijndaelManaged provider_AES = new RijndaelManaged();
            ICryptoTransform decrypt_AES = provider_AES.CreateDecryptor(byte_pwdMD5, provider_MD5.ComputeHash(Encoding.UTF8.GetBytes("mxdlongxing")));
